    ...
    <DashboardLayout user={profile}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Discover amazing places and manage your bookings.</p>
        </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Completed Stays</dt>
                    <dd className="text-lg font-medium text-gray-900">0</dd>
                  </dl>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-gray-400 transition-colors">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">Search Properties</h3>
                <p className="mt-1 text-sm text-gray-500">Find your perfect place to stay</p>
              </div>
            </button>
            ...
            <button className="p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">My Bookings</h3>
            ...
            <button className="p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">My Wishlist</h3>
                <p className="mt-1 text-sm text-gray-500">View saved properties and favorites</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Start exploring properties to see your activity here</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
