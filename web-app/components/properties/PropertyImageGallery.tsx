...
export function PropertyImageGallery({ images, propertyTitle, isMobile }: PropertyImageGalleryProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className="absolute bottom-4 right-4 bg-white/90 hover:bg-white text-gray-900 px-4 py-2 rounded-lg text-sm font-medium transition-colors border border-gray-300"
      >
