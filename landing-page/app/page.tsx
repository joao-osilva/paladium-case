  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-blue-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute w-96 h-96 bg-pink-200 rounded-full blur-3xl opacity-20"
          style={{ 
            top: '10%', 
            left: '5%',
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="px-4 py-2 bg-[#FF385C] text-white rounded-lg hover:bg-[#E31C5F] transition-colors font-medium"
              >
                Launch App
              </a>
              <a
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-[#FF385C] text-white rounded-xl font-semibold text-lg hover:bg-[#E31C5F] hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
            >
              Try Live App
            </a>
            <a
              href="#demo"
              className="px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold text-lg hover:border-gray-400 hover:bg-white transition-all duration-300"
            >
              Watch Demo
            </a>
            <a
      ...
      <footer className="py-8 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-600">
            © 2024 PaxBnb - AI-Powered Property Rental Platform
          </p>
          <div className="mt-4 flex justify-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-[#FF385C] transition-colors font-medium"
            >
              Live App
            </a>
